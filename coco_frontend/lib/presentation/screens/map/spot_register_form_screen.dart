...
class _SpotRegisterFormScreenState extends State<SpotRegisterFormScreen> {
  ...
  void initState() {
    super.initState();
    _nameController = TextEditingController(text: widget.picked.name);
  }
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
              content: Text(AppLocalizations.of(context)!
                  .spotRegisterSubmitFailedMessage)),
        );
      }
    }
  }
                  ...
                  children: [
                      ...
                      child: Row(
                        children: [
                          const Icon(Icons.location_on_rounded,
                              size: 18, color: CocoTheme.primary),
                          const SizedBox(width: 10),
                          Expanded(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text(widget.picked.name,
                                    style: const TextStyle(
                                        fontSize: 13,
                                        fontWeight: FontWeight.w600,
                                        color: CocoTheme.secondary)),
                                const SizedBox(height: 2),
                                Text(widget.picked.address,
                                    style: TextStyle(
                                        fontSize: 11,
                          ...
                          GestureDetector(
                            ...
                            child: const Text('변경',
                                style: TextStyle(
                                    fontSize: 12, color: CocoTheme.primary)),
                          ),
                        ],
                      ),
                    ),
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        hintText: '지도에 표시할 스팟 이름을 입력해 주세요',
                        counterText: '',
                      ...
                      children: [
                        Expanded(
                          child: _ToggleButton(
                            label: '상시',
                            active:
                                _exposure == 'always' && !_category.forcePeriod,
                      ...
                      children: [
                        const Text('한줄 소개',
                            style: TextStyle(
                                ...
                                fontWeight: FontWeight.w700,
                                color: CocoTheme.secondary)),
                        Text('${_introController.text.length}/80',
                            style: TextStyle(
                                fontSize: 11,
    ...
    return InkWell(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(12),
          border: Border.all(
              color: active ? CocoTheme.primary : Colors.grey.shade300),
        ),
        child: AnimatedDefaultTextStyle(
          duration: const Duration(milliseconds: 180),
          curve: Curves.easeOut,
